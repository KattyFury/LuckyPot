    ...
    <div className="card card-rows">
      <div className="two-col box-header">
        <span style={{ fontWeight: 700, color: "var(--color-primary)" }}>
          <span style={{ fontSize: "var(--fs-2)" }}>TOTAL TICKET</span>
          <span style={{ fontSize: "var(--fs-1)" }}>/POOL</span>
        </span>
        <span style={{ fontWeight: 700, color: "var(--color-primary)", textAlign: "left" }}>
          <span style={{ fontSize: "var(--fs-2)" }}>MY TICKETS</span>
          <span style={{ fontSize: "var(--fs-1)" }}>/MY DEPOSIT</span>
        </span>
      </div>
      ...
      <div className="two-col" style={{ fontFamily: "var(--font-condensed)" }}>
        <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
          <div style={{ fontSize: "var(--fs-4)", fontWeight: 700, display: "flex", alignItems: "baseline", gap: 6 }}>
            ...
            >
              <span className="icon icon-info" style={{ fontSize: "var(--fs-1)", color: "var(--color-text-secondary)" }} />
            </button>
          </div>
          <span style={{ fontSize: "var(--fs-1)", fontWeight: 700 }}>{unit}</span>
        </div>
        <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
          <div style={{ fontSize: "var(--fs-4)", fontWeight: 700, display: "flex", alignItems: "baseline", gap: 6 }}>
